...
LIB=
TESTS=./src/neuralnet.cpp ./src/api_outline.cpp ./test/catch_main.cpp ./test/test_neuralnet.cpp ./test/test_board.cpp ./src/board.cpp
OBJS=./src/neuralnet.o ./src/api_outline.o ./test/catch_main.o ./test/test_neuralnet.o ./test/test_board.o ./src/board.o
BIN=build/bin/
