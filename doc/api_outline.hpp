...
namespace skynet
{
	...
	void validate(const checkers_board_t& board); //Throws on bad board
	checkers_board_list_t move_generator(const checkers_board_t& board,const checkers_player_t& player); //Throws on bad board
